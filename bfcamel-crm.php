...
if ( defined( 'BFCAMEL_CRM_FILE' ) ) {
    $bfcamel_crm_duplicate_notice = static function () {
        ...
        echo '<div class="notice notice-error"><p><strong>BfCamel CRM:</strong> ' . esc_html__( 'A second active copy was detected and safely stopped. Remove the duplicate plugin directory and install the official bfcamel-crm.zip release package.', 'bfcamel-crm' ) . '</p></div>';
    };
...
define( 'BFCAMEL_CRM_VERSION', '0.5.2' );
