...
final class Bootstrap {
    ...
    public function menu() {
        ...
        add_submenu_page( 'bfcamel-crm', __( 'Dashboard', 'bfcamel-crm' ), __( 'Dashboard', 'bfcamel-crm' ), 'bfcamel_crm_view_submissions', 'bfcamel-crm', array( $admin, 'dashboard' ) );
        ...
        add_submenu_page( 'bfcamel-crm', __( 'Contacts', 'bfcamel-crm' ), __( 'Contacts', 'bfcamel-crm' ), 'bfcamel_crm_manage_contacts', 'bfcamel-crm-contacts', array( $admin, 'contacts_page' ) );
